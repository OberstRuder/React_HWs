...
function App() {
  ...
  let PopulationData = ({idNation, nation, idYear, year, population, slugNation}) => (
    <div>
  ...
  let SwapiData = ({ item }) => (
    <div>
      ...
      <p style={{ color: item.eye_color}}>Eye color: {item.eye_color}</p>
  ...
  let Episode = ({ episode }) => {
    return episode.characters !== undefined ? (
      <div>
  ...
  let Character = ({ character }) => {
    return character.episode !== undefined ? (
      <div>
  ...
  let RickCont = ({ episodes, characters }) => (
    <div>
  ...
  return (
    <div className="App">
      ...
      <h2>Population</h2>
      {data.map((item, index) => (
        <PopulationData key={index} idNation={item['ID Nation']} nation={item['Nation']} idYear={item['ID Year']} year={item['Year']} population={item['Population']} slugNation={item['Slug Nation']} />
      ))}
      <hr />
      ...
      <RickCont episodes={episodes} characters={characters} />
